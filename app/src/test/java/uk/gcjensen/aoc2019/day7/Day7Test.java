...
public class Day7Test {
    ...
    private final List<Long> part1TestInput = LongList.of(
        3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0
    );
    private final List<Long> part2TestInput = LongList.of(
    ...
    private final List<Long> actualInput = day7.parseInput();
